...
export default function CulturaPage() {
  ...
  if (isLoadingSession || (isLoading && !isError)) {
    // Skeleton no formato real das linhas — mesmo padrão já validado em
    // Usuários/Convites, em vez de spinner central (sugestão de UX, 05/09/2026).
    return (
      <div className="space-y-6">
        <div className="glass-card p-6">
          <div className="h-5 w-24 rounded bg-muted/60 animate-pulse mb-2" />
